...
BatteryRosAdapter::OnFault(const BatteryFault& fault)
{
    ...
    msg.fault_3 = fault.pack_status;
    msg.fault_4 = 0; msg.fault_5 = 0; msg.fault_6 = 0;
    msg.fault_7 = 0; msg.fault_8 = 0; msg.fault_9 = 0;
    msg.charger_overvoltage   = fault.charger_fault;
    msg.charge_overcurrent    = fault.chg_overcurrent_l1;
    msg.ntc_short             = fault.cell_ntc_short;
    msg.ntc_open              = fault.cell_ntc_open;
    msg.cell_voltage_diff     = false;
    msg.charge_timeout        = fault.chg_timeout;
    msg.discharge_overcurrent = fault.dischg_overcurrent_l1;
    msg.discharge_short       = fault.dischg_short;
    msg.secondary_overcharge  = fault.overcharge_l2;
